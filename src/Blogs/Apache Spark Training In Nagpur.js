...
function ApacheSparkTrainingInNagpur() {
  return (
    <div>
      <Helmet>
              ...
              <section id="blog-details" class="blog-details section">
                <div class="container">
                  <article class="article">
                    <div class="post-img">
                      <img src="img/blogs/68.png" alt="" class="img-fluid" />
                    </div>

                    <h2 class="title">Apache Spark Training In Nagpur</h2>
...
export default ApacheSparkTrainingInNagpur;
