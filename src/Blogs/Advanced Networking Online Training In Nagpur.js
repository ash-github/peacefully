...
function AdvancedNetworkingOnlineTrainingInNagpur() {
  return (
    <div>
      <Helmet>
              ...
              <section id="blog-details" class="blog-details section">
                <div class="container">
                  <article class="article">
                    ...
                    <h2 class="title">Advanced Networking Online Training In Nagpur</h2>
...
export default AdvancedNetworkingOnlineTrainingInNagpur
